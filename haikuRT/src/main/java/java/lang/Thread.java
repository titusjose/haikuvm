...
public class Thread implements Runnable {
    ...
    // be added to this class unless changes are also made to the VM and 
	// the former mentioned C struct.

	static private volatile Thread currentThread; // read only
	
	private volatile Runnable target;
	private volatile Thread next; // All Threads are in a circular queue.
	...
	private volatile Object locks; // HaikuVM will use this for an entry in a queue of locks for this thread
	private volatile boolean interrupt;
	private volatile Object waitingOn; // This Thread waits for this.waitingOn Object to be released
