...
public class Arduino {
   ...
   public static double min(double a, double b) {
    ...
    public static int digitalRead(byte p0) {
        return ArduinoImpl.digitalRead(p0);
    }

    public static int analogRead(byte p0) {
        return ArduinoImpl.analogRead(p0);
    }

    public static void analogReference(byte mode) {
        ArduinoImpl.analogReference(mode);
    }

    public static void analogWrite(byte p0, int p1) {
        ArduinoImpl.analogWrite(p0, p1);
    }
...
//    }
    ...
    public static void tone(byte _pin, int frequency) {
        ArduinoImpl.tone(_pin, frequency, 0);
    }

    public static void noTone(byte _pin) {
        ArduinoImpl.noTone(_pin);
    }
