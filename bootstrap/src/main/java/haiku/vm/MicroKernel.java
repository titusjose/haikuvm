...
//  case  64:   throw new OutOfMemoryError("Heap overflow: size needed="+haiku.vm.HaikuMagic.exceptionArg); 
        ...
        case 512:   throw new VirtualMachineError("VirtualMachineError OP code is "+(exceptionArg==0?"unimplemented":"unused")); 
        case 1024:  throw new ArithmeticException("ArithmeticException: Code="+exceptionArg); 
        }
        throw new VirtualMachineError("Unregistered Haiku Exception: exceptionCode="+exceptionCode+" arg="+exceptionArg);
    }
}
