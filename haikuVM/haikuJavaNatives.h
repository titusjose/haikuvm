...
typedef struct native_java_lang_Thread {
	...
	jstack stackframe;	//I
	stackFrame4Debug_t* stack;	//Ljava/lang/Object;
...
typedef struct {
	...
	OP_bc op7;                                                             // 7:    invokespecial	java.lang.Thread.setStateAndSwitch (I)I (24)
	OP_bc op10;                                                            // 10:   pop
...
extern void native_java_lang_Thread_setStateAndSwitch_II();
