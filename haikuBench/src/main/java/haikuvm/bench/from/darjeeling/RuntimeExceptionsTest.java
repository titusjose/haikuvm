...
public class RuntimeExceptionsTest
{
     ...
     * 2) PanicExceptions = NullPointerException | NoSuchMethodError | OutOfMemoryError | ClassCastException | VirtualMachineError | ArrayIndexOutOfBoundsException | StackOverflowError | ArithmeticException
     * 3) PanicSupport = 1
     *
     * @param args
     */
